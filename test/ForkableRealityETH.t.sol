...
import {IAMB} from "../development/contracts/interfaces/IAMB.sol";

import {L2Directory} from "../development/contracts/L2Directory.sol";
...
import {ForkableRealityETH_ERC20} from "../development/contracts/ForkableRealityETH_ERC20.sol";
import {RealityETH_v3_0} from "../development/contracts/RealityETH-3.0.sol";
import {AdjudicationFramework} from "../development/contracts/AdjudicationFramework.sol";

import {L2ForkArbitrator} from "../development/contracts/L2ForkArbitrator.sol";
...
contract ForkableRealityETHTest is Test {
    ...
    */
    ...
    // Directory contract on L2 that can tell us the addresses of contracts on L1
    address l2Directory;
    ...
    function setUp() public {
        ...
        l2Directory = new L2Directory(l2Bridge, l1GlobalRouter, l1ForkingManager, l1Token);
        ...
        */
        ...
        l2forkArbitrator.setRealitio(address(l2realityEth));
        l2forkArbitrator.setDisputeFee(5000);
        ...
        adjudicationFramework1 = new AdjudicationFramework(address(l2realityEth), 123, IAMB(address(0xab)));
