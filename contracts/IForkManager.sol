...
contract IForkManager is IERC20 {
    ...
    function init(address _parentForkManager, address _realitio, address _bridgeToL2, bool _hasGovernanceFreeze, uint256 _parentSupply, address _libForkManager, address _libForkableRealitio, address _ligBridgeToL2) external; 
